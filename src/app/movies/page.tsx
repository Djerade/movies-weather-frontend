        ...
        <div style={{ 
              ...
              <div>
                ...
                {(error as any).graphQLErrors && (error as any).graphQLErrors.length > 0 && (
                  <div style={{ marginTop: "0.5rem", fontSize: "0.9rem" }}>
                    Détails: {(error as any).graphQLErrors.map((err: any) => err.message).join(', ')}
                  </div>
                )}
          ...
          {loading && (
            <div style={{ textAlign: "center", padding: "4rem" }}>
              ...
              <p style={{ color: "#718096", fontSize: "1.2rem" }}>Recherche en cours...</p>
            </div>
          )}
            ...
            <div>
              <div style={{ 
                ...
                <span style={{ 
                  ...
                  {(data as any).searchMovies.totalResults} résultat{(data as any).searchMovies.totalResults !== "1" ? 's' : ''}
                </span>
              </div>
              ...
              <div style={{ 
                ...
                {(data as any).searchMovies.search.map((movie: MovieSearchResult, index: number) => (
                  ...
                  onMouseOut={(e) => {
                    ...
                    <div style={{ padding: "1.5rem" }}>
                      ...
                      <div style={{ 
                        ...
                        <span style={{ fontSize: "0.9rem", fontWeight: "600", color: "#1565c0" }}>
                          ID: {movie.imdbID}
                        </span>
                        <button
                          ...
                          onMouseOut={(e) => {
                            e.currentTarget.style.transform = "translateY(0)";
                            e.currentTarget.style.boxShadow = "0 3px 10px rgba(253, 121, 168, 0.3)";
                          }}
                        >
          ...
          {!searchTerm && !loading && (
            <div style={{ 
              ...
              <p style={{ 
                ...
                Utilisez la barre de recherche ci-dessus pour découvrir des milliers de films et ajoutez vos favoris à votre collection.
              </p>
            </div>
          )}
        </div>
