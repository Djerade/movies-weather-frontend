...
export default function DashboardPage() {
  ...
  const handleRemoveFromFavorites = async (imdbId: string, title: string) => {
    ...
    if (window.confirm(`Êtes-vous sûr de vouloir retirer "${title}" de vos favoris ?`)) {
      try {
          ...
          <div style={{ 
            ...
            <div style={{ position: "relative", zIndex: "1" }}>
              <div style={{ display: "flex", alignItems: "center", marginBottom: "1rem" }}>
                ...
                <h3 style={{ fontSize: "1.2rem", fontWeight: "600", margin: "0", color: "#2d3748" }}>Météo</h3>
              </div>
                ...
                <div>
                  ...
                  <div style={{ 
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                      ...
                      <span style={{ fontWeight: "600" }}>{(weatherData as any).weather.feelsLike}°</span>
                    </div>
                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                      <span style={{ color: "#718096" }}>Humidité:</span>
                      <span style={{ fontWeight: "600" }}>{(weatherData as any).weather.humidity}%</span>
                    </div>
                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                      <span style={{ color: "#718096" }}>Vent:</span>
                      <span style={{ fontWeight: "600" }}>{(weatherData as any).weather.windSpeed} km/h</span>
                    </div>
                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                      <span style={{ color: "#718096" }}>UV Index:</span>
                      <span style={{ fontWeight: "600" }}>{(weatherData as any).weather.uvIndex}</span>
                    </div>
                  </div>
                </div>
              )}
          ...
          <div style={{ 
            ...
            <div style={{ position: "relative", zIndex: "1" }}>
              <div style={{ display: "flex", alignItems: "center", marginBottom: "1rem" }}>
                ...
                <h3 style={{ fontSize: "1.2rem", fontWeight: "600", margin: "0", color: "#2d3748" }}>Favoris</h3>
              </div>
              
              <div style={{ textAlign: "center" }}>
                <div style={{ fontSize: "3rem", fontWeight: "700", color: "#e84393", marginBottom: "0.5rem" }}>
          ...
          <div style={{ 
            ...
            <div style={{ position: "relative", zIndex: "1" }}>
              <div style={{ display: "flex", alignItems: "center", marginBottom: "1rem" }}>
                ...
                <h3 style={{ fontSize: "1.2rem", fontWeight: "600", margin: "0", color: "#2d3748" }}>Profil</h3>
              </div>
              
              {user ? (
                <div>
                  <div style={{ marginBottom: "1rem" }}>
                    <p style={{ color: "#718096", fontSize: "0.9rem", margin: "0 0 0.25rem 0" }}>Nom</p>
                    <p style={{ fontWeight: "600", margin: "0", color: "#2d3748" }}>{user.name}</p>
                  </div>
                  <div style={{ marginBottom: "1rem" }}>
                    <p style={{ color: "#718096", fontSize: "0.9rem", margin: "0 0 0.25rem 0" }}>Email</p>
                    <p style={{ fontWeight: "600", margin: "0", color: "#2d3748", fontSize: "0.9rem" }}>{user.email}</p>
                  </div>
                  <div>
        ...
        <div style={{ 
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "2rem", flexWrap: "wrap", gap: "1rem" }}>
            ...
            {(favoritesData as any)?.getFavoriteMovies?.length > 0 && (
              <span style={{ 
                ...
                {(favoritesData as any).getFavoriteMovies.length} film{(favoritesData as any).getFavoriteMovies.length > 1 ? 's' : ''}
              </span>
            )}
          </div>
          ...
          {favoritesLoading && (
            <div style={{ textAlign: "center", padding: "3rem" }}>
              ...
              <p style={{ color: "#718096", fontSize: "1.1rem" }}>Chargement de vos favoris...</p>
            </div>
          )}
          ...
          {(favoritesData as any)?.getFavoriteMovies && (favoritesData as any).getFavoriteMovies.length > 0 ? (
                  ...
                  <div style={{ padding: "1.5rem" }}>
                    ...
                    {movie.imdbRating && (
                      <div style={{ 
                        ...
                        <span style={{ fontSize: "0.9rem", fontWeight: "600", color: "#744210" }}>
                          Note IMDb
                        </span>
                        <span style={{ 
                          fontSize: "1.1rem", 
            ...
            <div style={{ 
              ...
              <p style={{ 
                ...
                Commencez à explorer et ajoutez vos films préférés à votre collection personnelle.
              </p>
              <a
                href="/movies"
                style={{ 
